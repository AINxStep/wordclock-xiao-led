...
// PIEZA 1: CUERPO PRINCIPAL CON TORRETAS TRASERAS REBAJADAS 2.0 mm
// Las torretas miden 33.0 mm de alto para alojar la tapa de 2.0 mm AL RAS del marco (35.0 mm total)
// ==============================================================================
...
module wordclock_main_frame() {
    union() {
        ...
        // TORRETAS TRASERAS REBAJADAS 2.0 MM (33.0 mm de altura) para alojar la tapa al ras
        lid_thick   = 2.0;
