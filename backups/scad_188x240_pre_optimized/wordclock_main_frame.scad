...
// Proporción 4:5 Uniforme: 188.0 mm (Ancho) x 240.0 mm (Alto)
// LED Density: WS2812B 74 LEDs/m (Pitch = 13.5135 mm)
// ==============================================================================
...
box_w       = 188.0;   // Ancho del marco exterior (mm) - Margen uniforme ~2.5 cm
...
margin_x    = (box_w - grid_w) / 2;       // ~26.43 mm (Margen uniforme lateral)
margin_top  = (box_h - grid_h - led_pitch) / 2; // ~25.41 mm (Margen uniforme vertical)
...
module wordclock_main_frame() {
    union() {
        difference() {
            // 1. Paredes Exteriores del Marco (188 x 240 mm) + Tapa Frontal
