...
module wordclock_main_frame() {
    union() {
        ...
        // 5. Torretas de fijación M3 EXTERIORES para la Tapa Trasera (Incrustada al ras)
        lid_thick   = 2.0;
        rear_boss_h = box_d - lid_thick; // 33.0 mm (permite que la tapa de 2.0 mm quede al ras)
