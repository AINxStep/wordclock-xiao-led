// ==============================================================================
// WORDCLOCK ESP32 - OPCION 1: MARCO IMPRESO ORIGINALMENTE (3.0 mm Pared)
// PIEZA 1: CUERPO PRINCIPAL (MARCO + STENCIL + BAFFLE INTEGRADOS)
// Modelo exacto coincidente con la impresión original realizada por el usuario.
// Offset de tornillos de las esquinas: 7.0 mm (wall_thick = 3.0 mm + 4.0 mm)
// ==============================================================================
...
wall_thick  = 3.0;     // Pared exterior original de 3.0 mm
...
face_thick  = 2.4;     // Grosor de carátula
baffle_h    = 12.0;    // Altura de baffle
baffle_wall = 1.2;
...
module wordclock_main_frame() {
    union() {
        ...
        // TORRETAS TRASERAS DE TORNILLOS ALINEADAS EXACTAMENTE CON LA IMPRESION ORIGINAL (Offset: 7.0 mm)
