// ==============================================================================
// WORDCLOCK ESP32 - OPCION 2: MARCO OPTIMIZADO PARA TAPA AL RAS (1.6 mm Pared)
// PIEZA 1: CUERPO PRINCIPAL CON TORRETAS TRASERAS REBAJADAS A 33.0 mm
// Diseñado para alojar la tapa incrustada de 2.0 mm 100% al ras del marco
// ==============================================================================
...
box_h       = 240.0;
box_d       = 35.0;
wall_thick  = 1.6;     // Pared optimizada de 1.6 mm (coincide con la carátula)
...
module wordclock_main_frame() {
    union() {
        ...
        // TORRETAS TRASERAS REBAJADAS A 33.0 MM (box_d - lid_thick) PARA ALOJAR TAPA DE 2.0 MM AL RAS
        lid_thick   = 2.0;
        rear_boss_h = box_d - lid_thick; // 33.0 mm
        screw_off   = wall_thick + 4.0;  // 5.6 mm
